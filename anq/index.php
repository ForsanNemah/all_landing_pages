...
if ($handle = opendir('logo')) {
  ...
  <img   src='logo/$entry' class='img-fluid' alt='Responsive image' width='400px' height='500px' >
...
?>
                                    ...
                                    <div class="form-group">
                                        <input name="name" type="text" class="form-control" value="عبر وتساب مباشر" placeholder="الاسم"  hidden >
                                    </div>
...
<button id="send1" type="submit" class="btn submit-btn btn-success ">
                                        
                                       تواصل مع  جمعية عنك الخيرية من هنا 
