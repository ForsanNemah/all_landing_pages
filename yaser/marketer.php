...
?>
<?php
if (isset($_SESSION['adminSession'])||isset($_SESSION['customerSession'])) {
...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Marketer</li>
    ...
    <div class="card">
      <div class="card-body mt-2">
        <button type="button" class="btn btn-success" data-toggle='modal' data-target='#add-admin-modal' id="btnaddmarketer"><i class="bi bi-person-plus-fill">Add Marketer</i></button>
        <button type="button" class="btn btn-primary" data-toggle='modal' data-target='#edit-Marketer-modal'><i class="ri-refresh-fill">Update</i></button>
    ...
    <section class="section" style="display: block;" id="table">
      <div class="row d-flex justify-content-center">
        <div class="col-lg-10">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Marketers Data</h5>
    ...
    <!-- The Modal -->
    <div class="modal" id="edit-Marketer-modal">
      <div class="modal-dialog">
        <div class="modal-content">

          <!-- Modal Header -->
          <div class="modal-header">
            <h4 class="modal-title">Edit Marketer</h4>
            <button type="button" class="close" data-dismiss="modal">&times;</button>
          </div>

          <!-- Modal body -->
          <div class="modal-body">
            <form action="marketer/php/updateMarketers.php" id="edit-form">
    ...
    <div class="modal" id="add-admin-modal">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <!-- Modal body -->
          <div class="modal-body">
            <form action="marketer/php/saveMarketers.php" id="addform">
              <div class="form-group">
  ...
  <!-- Page Script -->
  <script src="marketer/js/Marktersscripts.js"></script>
