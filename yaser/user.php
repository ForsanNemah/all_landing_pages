  ...
  <main id="main" class="main">
    ...
    <div class="card">
      <div class="card-body mt-2">
        <button type="button" class="btn btn-success"  data-toggle='modal' data-target='#add-admin-modal'><i class="bi bi-person-plus-fill">Add User</i></button>
        <button type="button" class="btn btn-primary" data-toggle='modal' data-target='#edit-user-modal' ><i class="ri-refresh-fill">Update</i></button>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
          ...
          <div class="modal-body">
            <form action="admin/php/updateUser.php" id="edit-form">
            ...
            <button type="button" id="btnCanel" class="btn btn-danger float-right"  data-dismiss="modal">Close</button>
        </form>
...
<div class="modal" id="add-admin-modal">
  <div class="modal-dialog">
    <div class="modal-content">
        ...
        <!-- Modal body -->
        <div class="modal-body">
			    <form action="admin/php/saveUser.php" id="addform">
				  	<div class="form-group">
            ...
            <button type="button" id="btnCanel" class="btn btn-danger float-right" data-dismiss="modal">Cancel</button>
				</form>
        </div>
  ...
  <script src="admin/JS/Userscripts.js"></script>
