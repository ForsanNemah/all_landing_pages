...
$action_url="https://script.google.com/macros/s/AKfycbx-LQyi18X7uDHgeDKHEWbC13tVjXQ0mgJNi2ECgQ8lmEl_ri9-KYYT3NtM1kMdbKhw/exec";
...
$items_branches['Peter'.$i]=$line;
    ...
    $items_services2 = array();



$handle = fopen("services2.txt", "r");
if ($handle) {
$i=0;
    while (($line = fgets($handle)) !== false) {
        //echo $line."<br>".$i; 
$i++;
$items_services2['Peter'.$i]=$line;
