        ...
        <div class="st-top-header-in">
          <ul class="st-top-header-list">
            ...
            <li>
              ...
              <a href="tel: <?php echo $phn;?>">  <?php echo $phn;?> </a></li>
          </ul>
          <a href="#appointment" class="st-top-header-btn st-smooth-move">حجز موعد</a>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="st-main-header-left" >
          ...
          <div class="st-main-header-right "  >
            <div class="st-nav  ">
              <ul id="menu_ul" class="st-nav-list st-onepage-nav  ">

              
                <li><a href="#home" class="st-smooth-move"
                
                
                onclick="col_down()"
                
                >الرئيسية</a></li>
                <li><a href="#about" class="st-smooth-move"
                ...
                <li hidden><a href="#price" class="st-smooth-move">الاسعار</a></li>
                <li hidden class="menu-item-has-children"><a href="#blog" class="st-smooth-move">المدونة</a>
                  <ul>
    ...
    <div class="st-hero-wrap st-gray-bg st-dynamic-bg overflow-hidden st-fixed-bg" data-src="assets/img/dental/hero-bg.jpg">
      <div class="st-hero st-style1">
        ...
        مجمعات رويال الطبية 
            ...
            تأسست عيادات رويال في عام 2016 مع الالتزام بتقديم خدمات رعاية صحية
            <br>
            عالية الجودة في مجال طب الأسنان
               

               
              
              يتكون فريقنا من استشاريين ومتخصصين 
              
              <br>
              ذوي مهارات عالية يقدمون الخدمات الطبية المتاحة الأكثر تقدمًا.
        ...
        <div class="st-hero-social-group" hidden>
          <div class="container">
