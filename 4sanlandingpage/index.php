...
<body class="rtl">
          ...
          <div class="st-main-header-right">
            <div class="st-nav">
              <ul class="st-nav-list st-onepage-nav">
                ...
                <li><a href="#about" class="st-smooth-move">عنا</a></li>
  ...
  <div class="st-content">
    ...
    <section id="doctors">
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">الدكاترة</h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
       ...
       نفخر بامتلاكنا كادر  مؤهل ذو خبرة واسعة 
                ...
                <div class="st-member st-style1 st-zoom">
                  <div class="st-member-img">
                    ...
                    <div class="st-member-social-wrap">
                      ...
                      <ul class="st-member-social st-mp0" hidden>
                        <li><a href="#"><i class="fab fa-facebook-square"></i></a></li>
                        <li><a href="#"><i class="fab fa-linkedin"></i></a></li>
                        <li><a href="#"><i class="fab fa-pinterest-square"></i></a></li>
                        <li><a href="#"><i class="fab fa-twitter-square"></i></a></li>
        ...
        <div class="st-portfolio-wrapper">
          <div class="st-isotop-filter st-style1 text-center">
            <ul class="st-mp0">
              ...
              <li><a href="#" data-filter=".cardiology">قسم الاسنان </a></li>
              <li><a href="#" data-filter=".neurology">قسم التجميل</a></li>
    ...
    <section>
      ...
      <div class="container">
        <div class="st-section-heading st-style1">
          <h2 class="st-section-heading-title">ماذا قالو عنا </h2>
          <div class="st-seperator">
            <div class="st-seperator-left wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            <div class="st-seperator-center"><img src="assets/img/icons/4.png" alt="icon"></div>
            <div class="st-seperator-right wow fadeInRight" data-wow-duration="1s" data-wow-delay="0.2s"></div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <div class="st-funfact-title">عام من الخبرة</div>
                </div>
              ...
              <div class="col-lg-6">
                <div class="st-funfact st-style1">
                  ...
                  <div class="st-funfact-title">عيادة</div>
                </div>
                <div class="st-height-b30 st-height-lg-b30"></div>
              </div><!-- .col -->
            </div>
              ...
              <div class="slick-slide-in">
                <div class="st-pricing-table st-style1">
                  <div class="st-pricing-head">
                    ...
                    <img src="assets/img/shape/price-shape.svg" alt="shape" class="st-pricing-head-shape">
                  </div><!-- .st-pricing-head -->
    ...
    <!-- Start FAQ Section -->
    <section class="st-faq-wrap st-shape-wrap" hidden>
      <div class="st-shape5">
    ...
    <!-- Start News Letter -->
    <section    hidden class="st-news-letter-section st-dynamic-bg st-bg" data-src="assets/img/news-letter-bg.png">
      <div class="container">
        <div class="st-section-heading st-style1">
    ...
    <section hidden class="st-shape-wrap" id="contact">
