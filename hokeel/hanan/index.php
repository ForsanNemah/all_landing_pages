                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form">
                            <div class="text-center">
                                <form name="myform" target="_self"     action="https://script.google.com/macros/s/AKfycbxsybp9_adZz_3vQTEpKeK_fSsBlYeqQsQaOw_NcWQpAmAtyEAmh6fCvxglA8JBg4tSPw/exec" method="post">
