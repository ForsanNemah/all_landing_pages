...
<!DOCTYPE html>
<!-- saved from url=(0038)https://royaljubail.everestsoftjo.com/ -->
<html lang="en"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link rel="stylesheet" href="./index_files/bootstrap.min.css" integrity="sha384-JcKb8q3iqJ61gNV9KGb8thSsNjpSL0n8PARn9HuZOnIxN0hoP+VmmDGMN5t9UJ0Z" crossorigin="anonymous">
    ...
    <script type="text/javascript" async="" src="./index_files/config.js.download"></script><script type="text/javascript" async="" src="./index_files/events.js.download"></script><script type="text/javascript" async="" src="./index_files/analytics.js.download"></script><script type="text/javascript" async="" src="./index_files/scevent.min.js.download"></script><script async="" src="./index_files/gtm.js.download"></script><script src="./index_files/jquery.min.js.download"></script>
    <title>
...
<script charset="utf-8" src="./index_files/identify.js.download"></script>
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6">
                <div class="text-center header-logo">
                    <div class="logo">
                        <img src="ads/logo.png" alt="logo" width="220px" height="200px">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="form">
                            <div class="text-center">
                                <form name="myform" target="_self" onsubmit="return doSomething();"   action="https://script.google.com/macros/s/AKfycbxcwMigNCbS6KKAtTAA8edxJ9KdFoVUCAO9do4biMt0FK3EkIlBjsj539noFLnHq4vr/exec" method="post">
                                    <p class="appointment-title text-dark"> 
...
?>
                                    ...
                                    <p class="appointment-title text-dark" style="font-size:1.2em;direction:rtl"
...
include 'info.php';
 ...
 echo $info['pres_here_to_register'];
...
<br>
    ...
    <div class="carousel-inner">
        ...
        <div class="carousel-item active">
            <img class="d-block w-100" src="ads/7.jpg" alt="First slide">
        ...
        <div class="carousel-item">
            <img class="d-block w-100" src="ads/8.jpg" alt="Second slide">
        </div>

        <div class="carousel-item">
            <img class="d-block w-100" src="ads/7.jpg" alt="Third slide">
        </div>
    </div>
        ...
        function postToGoogle() {
            ...
            $.ajax({
                ...
                error: function (x, y, z) {
                    ...
                    window.location.replace("https://royaljubail.everestsoftjo.com/thankyou.html");
...
a._i=a._i||{};a._i[b]=[];a._i[b]._u=f;a._t=a._t||{};a._t[b]=+new Date;a._o=a._o||{};a._o[b]=c||{};c=document.createElement("script");c.type="text/javascript";c.async=!0;c.src=f+"?sdkid\x3d"+b+"\x26lib\x3d"+e;b=document.getElementsByTagName("script")[0];b.parentNode.insertBefore(c,b)};a.load("CDQU6FJC77U1DP3CADCG");a.page()}(window,document,"ttq");</script>
	</body><iframe id="__JSBridgeIframe_1.0__" title="jsbridge___JSBridgeIframe_1.0__" style="display: none;" src="./index_files/saved_resource.html"></iframe><iframe id="__JSBridgeIframe_SetResult_1.0__" title="jsbridge___JSBridgeIframe_SetResult_1.0__" style="display: none;" src="./index_files/saved_resource(1).html"></iframe><iframe id="__JSBridgeIframe__" title="jsbridge___JSBridgeIframe__" style="display: none;" src="./index_files/saved_resource(2).html"></iframe><iframe id="__JSBridgeIframe_SetResult__" title="jsbridge___JSBridgeIframe_SetResult__" style="display: none;" src="./index_files/saved_resource(3).html"></iframe></html>
