...
<!--
  ...
  <a class="navbar-brand" >
      <img src="assets/logo_3.jpg" width="130" height="130" alt="MDB Logo"
        loading="lazy" />
    </a>
      ...
      <div class="collapse navbar-collapse" id="navbarDefault">
        ...
        <ul class="navbar-nav mr-auto ">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">التشاور </a>
