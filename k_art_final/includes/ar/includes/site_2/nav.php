...
<a class="navbar-brand" >
      <img src="assets/logo_2.jpg" width="130" height="130" alt="MDB Logo"
        loading="lazy" />
    </a>
     ...
     -->
      ...
      <div class="collapse navbar-collapse" id="navbarDefault">
        ...
        <ul class="navbar-nav mr-auto ">
          ...
          <li class="nav-item"    >
            <a class="nav-link " onclick="close_nav()" href="#customers"    >عملائنا </a>
          </li>

          
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">التشاورات</a>
            <div class="dropdown-menu">
              <a class="dropdown-item " href="https://sprw.io/stt-a96709" target="_blank">مسح عملية ما قبل التصميم </a>
          ...
          <li class="nav-item dropdown">
            ...
            <a class="dropdown-item " href="index_1.php">المقاولات العامة والتصميم الداخلي </a>
              <a class="dropdown-item " href="index_2.php">صناعة الخشب  </a>
