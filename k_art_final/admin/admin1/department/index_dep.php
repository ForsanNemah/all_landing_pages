...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE  department SET dep_name='$name',dep_name_en='$name_en', block='$block', video_url='$video_url'
...
if(isset($_POST['save'])){
    ...
    $sql = "INSERT INTO department (dep_name,dep_name_en,video_url,block)
                          VALUES ('$name','$name_en','$video_url', '$block')";
