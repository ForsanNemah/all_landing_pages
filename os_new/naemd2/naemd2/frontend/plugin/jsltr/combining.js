...
var Autocare = (function() {
            ...
            $(".scroll")
                ...
                .on("click", function(e) {
                    if ((e.preventDefault(), "" !== this.hash)) {
                        ...
                        var r = i - n;
                        $("html, body").animate({ scrollTop: r }, 800, function() {});
                    }
                }),
        ...
        n = function() {
            ...
            if (
                ...
                if (0 == $(".mo-left .header-nav").children("div").length) {
                    var i = jQuery("<div>").append($(".mo-left .logo-header").clone()).html();
                    jQuery(".mo-left .header-nav").prepend(i),
    ...
    u.setMonth(u.getMonth() + 1),
        (u = u.getDate() + " " + monthNames[u.getMonth()] + " " + u.getFullYear());
    var c = function() {
        ...
        init: function() {
            jQuery(".box-hover").on("mouseenter", function() {
                ...
                jQuery(window).on("resize", function() {
                    jQuery(".modal:visible").each(l), jQuery(".equal-wraper").length && r(".equal-wraper .equal-col"), a();
                }),
