...
<input type="checkbox" id="vehicle1" name="1" value=" الموارد البشرية " style="color:black">
<label for="checkbox"> الموارد البشرية </label>

 
<input type="checkbox" id="vehicle1" name="2" value=" الخدمات الذاتية " style="color:black">
<label for="checkbox">الخدمات الذاتية </label>

<input type="checkbox" id="vehicle1" name="3" value="المالية" style="color:black">
<label for="checkbox">المالية </label>


<input type="checkbox" id="vehicle1" name="4" value="المبيعات" style="color:black">
<label for="checkbox"> المبيعات </label>

<input type="checkbox" id="vehicle1" name="5" value="المخازن" style="color:black">
<label for="checkbox">المخازن </label>


<input type="checkbox" id="vehicle1" name="6" value="المشتريات" style="color:black">
<label for="checkbox">المشتريات</label>

<input type="checkbox" id="vehicle1" name="7" value=" ادارة المشاريع الاحترافية " style="color:black">
<label for="checkbox">ادارة المشاريع الاحترافية </label>

<input type="checkbox" id="vehicle1" name="8" value="ادارة الاملاك" style="color:black">
<label for="checkbox">ادارة الاملاك</label>
