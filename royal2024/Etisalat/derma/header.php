...
<header class="st-site-header st-style1 st-sticky-header">
    <div class="st-top-header">
      <div class="container">
        <div class="st-top-header-in" hidden>
          ...
          <div class="st-main-header-right "  >
            <div class="st-nav  ">
              <ul id="menu_ul" class="st-nav-list st-onepage-nav  ">
                ...
                <li hidden><a href="#cases" class="st-smooth-move"
                ...
                <li hidden><a href="#customers_testi" class="st-smooth-move"
                ...
                <li hidden><a href="#contact" class="st-smooth-move"
