...
<div class="form-group"  hidden >
    ...
    <input type="text" name="source" id="source"  value="1" class="r-form-1-email form-control" id="r-form-1-email"  >
</div>


<div class="form-group"   hidden  >
<input type="text" name="type"  placeholder=" التاريخ  " class="r-form-1-email form-control" id="r-form-1-email"  value="vid" >
</div>
