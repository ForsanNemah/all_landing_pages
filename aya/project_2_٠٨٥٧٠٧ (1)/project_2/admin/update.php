          ...
          <form action="index.php" method="post">
              <input type="hidden" name="id" value="<?=$admin['id'];?>"/>
                        ...
                        <h5>   <label> الاسم باللغة العربية </label> </h5>
                            <input class="form-control" type="text" required="" name="ad_name" value="<?=$admin['ad_name'];?>"/>
                        </div>

                        <div class="mb-4">
                          <h5>  <label> الاسم باللغة الانجليزية </label> </h5>
                            <input class="form-control" type="text" required="" name="ad_name_en" value="<?=$admin['ad_name_en'];?>"/>
                        </div>

                        <div class="mb-4">
                        <h5> <label>    البريد الإلكتروني  </label> </h5>
                            <input class="form-control" type="email" required="" name="email" value="<?=$admin['email'];?>"/>
                        </div>
