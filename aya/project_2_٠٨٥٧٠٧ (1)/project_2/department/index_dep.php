...
if(isset($_POST['update'])){
    ...
    $sql = "UPDATE  department SET dep_name='$name',dep_name_en='$name_en',desc_dep ='$descr_dep',price_dep='$price_dep', block='$block'
...
if(isset($_POST['save'])){
    ...
    $sql = "INSERT INTO department (dep_name,dep_name_en,desc_dep,price_dep ,block)
                          VALUES ('$name','$name_en','$descr_dep','$price_dep', '$block')";
