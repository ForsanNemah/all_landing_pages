...
if(isset($_POST['delete']))
{
  ...
  /*كود تعديل بيانات الادمن المحدد */
    if(isset($_POST['update'])){
        ...
        $sql = "UPDATE  admins SET ad_name='$name', email='$email', password='$pass', block='".$block."'
                     where id='$ad_id'  ";
...
/*كود حفظ سجل لادمن جديد */
    if(isset($_POST['save'])){
     ...
     $block=mysqli_real_escape_string($con,$_POST['block']);
        ...
        if($pass == $pass_confirm)
        {
        $sql = "INSERT INTO admins (ad_name,email,password,block)
                          VALUES ('$name', '$email', '$pass','".$block."')";
