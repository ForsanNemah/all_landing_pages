                        ...
                        if(mysqli_num_rows($query_run)> 0){
                            ...
                            <form action="index_project.php" method="post" enctype="multipart/form-data">
                                ...
                                <h5>  <label> اسم المشروع باللغة العربية   </label> </h5>
                                    <input class="form-control" type="text" required="" name="name" value="<?=$pro['project_name'];?>"/>
                                </div>

                                <div class="mb-5">
                                    <h5> <label> اسم المشروع باللغة الإنجليزية   </label> </h5>
                                    <input class="form-control" type="text" required="" name="name_en" value="<?=$pro['project_name_en'];?>"/>
                                </div>

                                 <div class="mb-5">
                                 <h5>  <label> الملف  </label> </h5>
                                    <input class="form-control" type="file"  name="project_url"  accept=".pdf,.xlsx"/>
                                    <input type="hidden" value="<?=$pro['project_url'];?>" name="project_url_old" >
