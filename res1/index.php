...
if ($handle = opendir('logo')) {
  ...
  <img   src='logo/$entry' class='img-fluid' alt='Responsive image' width='200px' height='300px' >
...
<br>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <a href="https://drive.google.com/file/d/1N-ekGihr39ioxEJx4An361YvvFFo4UMK/view?usp=sharing">

                                    <button type="button" class="btn btn-primary">تصفح المنيو</button>
 ...
 <!--
                                  ...
                                  <div class="form-group">
                                    ...
                                    <a href="location_picker.php">

                                    <button type="button" class="btn btn-primary">حدد موقعك</button>
...
-->
                                    ...
                                    <div class="form-group">
                                        <input name="info" type="text" class="form-control" placeholder="معلومات الطلب" dir="rtl" required>
                                    </div>
...
<div class="form-group" hidden>
                                    ...
                                    <button id="send" type="submit" class="btn submit-btn">تأكيد الطلب  </button>
                                </form>
                            </div>
                        </div>
                    </div>
...
$(document).ready(function () {
  ...
  $('#x_id').attr('value', localStorage.getItem("final_x") )
  $('#y_id').attr('value', localStorage.getItem("final_y") )
