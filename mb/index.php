...
<img src="ads/done.gif" class="img-fluid" width='100px' height='100px' alt="Responsive image"   >
                                ...
                                <form  id="form" action="mb/fileupload.php" method="post" enctype="multipart/form-data">
...
?>
                                  ...
                                  <div class="form-group">
                                        <input name="file" type="file" class="form-control" placeholder="Excel File" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <input name="sender_email" type="text" class="form-control" placeholder="Email" required>
                                    </div>
                                    ...
                                    <select name="secure_type" id="cars" hidden>
  <option value="ENCRYPTION_SMTPS">ENCRYPTION_SMTPS</option>
  <option value="PHPMailer::ENCRYPTION_STARTTLS">PHPMailer::ENCRYPTION_STARTTLS</option>
    ...
    <input type="text" name="datetime" id="today" placeholder=" التاريخ  " class="r-form-1-email form-control" id="r-form-1-email"  >
                                    ...
                                    <button id="send" type="submit" class="btn submit-btn">   اطلاق الحملة</button>
                                </form>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 col-lg-12 text-center">
                    <a class="btn btn-primary" style="background-color: #1c3c49 " href="#form">  اطلق حملتك الان </a>
                </div>
            </div>
        </div>
    </section>
